module.exports = (grunt) ->
	...
	taskConfig = 
		...
		clean:
			default: 'app/assets'
			dist: [
				'dist/snackk-web-api-recommend.min.js'
				'dist/snackk-web-api-recommend.min.js.map'
			]
		...
		requirejs:
			...
			api:
				options:
					mainConfigFile: 'api/assets/src/recommend-config.js'
					baseUrl: 'api/assets/src'
					out: 'dist/snackk-web-api-recommend.min.js'
					onBuildRead: (moduleName, path, contents) ->
						return contents.replace /\/assets/g, '/dist'
					include: ['../almond', 'recommend']
					exclude: ['lodash']
					wrap: {
